...
[Materials]
  [./ha]
    ...
    all_etas = 'gr0 gr1 gr2 solid2 liquid'
    phase_etas = 'gr0 gr1 gr2'
    h_name = ha
  [../]
  [./hl]
    type = SwitchingFunctionMultiPhaseMaterial
  ...
  [./const]
    ...
    prop_names = 'Vm         kappa_s  gamma mu   Ls  f0         S     Tm   kappa_l'
    prop_values = '1.1798e-2 3.84e-3  1.5   0.6 1.0 1.41044e-2  1.9e2  1660 3e-1'
  [../]
  [./fb]
  ...
  [./chi]
    type = DerivativeParsedMaterial
    property_name = chi
    material_property_names = 'Vm ha(gr0,gr1,gr2,solid2,liquid) ka hb(gr0,gr1,gr2,solid2,liquid) kb hl(gr0,gr1,gr2,solid2,liquid) kl'
    expression = '(ha/ka + hb/kb + hl/kl)/(Vm^2)'
    coupled_variables = 'gr0 gr1 gr2 solid2 liquid'
    derivative_order = 2
  [../]
  [./Mobility]
    type = DerivativeParsedMaterial
...
[Kernels]
  ...
  [./sw_gr0]
    ...
    hj_names = 'ha    hb      hl'
    coupled_variables = 'w solid2 liquid gr1 gr2'
    mob_name = Ls
  [../]
  [./int_gr0]
    type = ACInterface
  ...
  [./sw_gr1]
    ...
    Fj_names = 'omegaa omegab omegal'
    hj_names = 'ha    hb      hl'
    coupled_variables = 'w solid2 liquid gr0 gr2'
    mob_name = Ls
  [../]
  [./int_gr1]
    type = ACInterface
  ...
  [./sw_gr2]
    ...
    Fj_names = 'omegaa omegab omegal'
    hj_names = 'ha    hb      hl'
    coupled_variables = 'w solid2 liquid gr0 gr1'
    mob_name = Ls
  [../]
  [./int_gr2]
    type = ACInterface
  ...
  [./sw_s2]
    ...
    Fj_names = 'omegaa omegab omegal'
    hj_names = 'ha    hb      hl'
    coupled_variables = 'w gr0 gr1 gr2 liquid'
    mob_name = Ls
  [../]
  [./int_s2]
    type = ACInterface
  ...
  [./sw_l]
    ...
    Fj_names = 'omegaa omegab omegal'
    hj_names = 'ha    hb      hl'
    coupled_variables = 'w gr0 gr1 gr2 solid2'
    mob_name = Ls
  [../]
  [./int_l]
    type = ACInterface

[Mesh]
  ...
  [Materials]
    ...
    [./const]
      ...
      prop_names = 'Vm         kappa_s  gamma mu   Ls   f0         '
      prop_values = '1.1798e-2 3e-3      1.5  0.6  1.0   1.41044e-2'
    [../]
    [./fb]
    ...
    [./fa]
      ...
      property_name = fa
      material_property_names = 'f0'
      expression = 'f0*(-2.492652e-2 * T^2 - 2.7321e1 * T + 2556.9553)'
    [../]
    [./kb]
      type = DerivativeParsedMaterial
      coupled_variables = 'T'
    ...
    [./ka]
      ...
      property_name = ka
      material_property_names = 'f0'
      expression = 'f0*(-4.86714527e-18 * T^8 + 3.9143875e-14 * T^7 - 1.32577938e-10 * T^6 + 2.450055e-7 * T^5 - 2.6693366e-4 * T^4 + 1.720023e-1 * T^3 - 61.45912*T^2 + 10041.28*T - 2.761182e5)'
    [../]
    [./omegaa]
      type = DerivativeParsedMaterial
      coupled_variables = 'w'

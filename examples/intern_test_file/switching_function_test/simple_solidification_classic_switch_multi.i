...
[Materials]
    [./hl]
        ...
        property_name = hl
        expression = '(liquid^3 * (10 - 15*liquid + 6*liquid^2)) / ((liquid^3 * (10 - 15*liquid + 6*liquid^2))+(gr0^3 * (10 - 15*gr0 + 6*gr0^2))+(gr1^3 * (10 - 15*gr1 + 6*gr1^2)))'
    [../]
    [./h0]
        type = DerivativeParsedMaterial
        coupled_variables = 'liquid gr0 gr1'
        property_name = h0
        expression = '(gr0^3 * (10 - 15*gr0 + 6*gr0^2)) / ((liquid^3 * (10 - 15*liquid + 6*liquid^2))+(gr0^3 * (10 - 15*gr0 + 6*gr0^2))+(gr1^3 * (10 - 15*gr1 + 6*gr1^2)))'
    [../]
    [./h1]
        type = DerivativeParsedMaterial
        coupled_variables = 'liquid gr0 gr1'
        property_name = h1
        expression = '(gr1^3 * (10 - 15*gr1 + 6*gr1^2)) / ((liquid^3 * (10 - 15*liquid + 6*liquid^2))+(gr0^3 * (10 - 15*gr0 + 6*gr0^2)) + (gr1^3 * (10 - 15*gr1 + 6*gr1^2)))'
    [../]
  [./omegal]
      type = DerivativeParsedMaterial

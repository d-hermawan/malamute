[Mesh]
  ...
  [Materials]
    [./ha]
      ...
      h_name = ha
      all_etas = 'etaa0 etaa1 etaa2 etab0'
      phase_etas = 'etaa0 etaa1 etaa2'
    [../]
    [./hb]
      type = ADSwitchingFunctionMultiPhaseMaterial
      h_name = hb

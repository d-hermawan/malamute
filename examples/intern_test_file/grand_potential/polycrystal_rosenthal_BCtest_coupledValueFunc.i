...
[Functions]
    ...
    [./bc_coupled]
        type = ParsedFunction
        expression = '(0.5*tanh(0.015*(x-1550)) + 0.5)'
    [../]
[]
[ICs]
    [./bubble_IC]
...
[AuxKernels]
    [./bnds_aux]
        ...
        v = 'liquid gr0 gr1 gr2 gr3 gr4 gr5 alphaP'
    [../]
    [./temp_src]
...
[Materials]
    [./hl]
        ...
        all_etas = 'liquid gr0 gr1 gr2 gr3 gr4 gr5 alphaP'
        phase_etas = liquid
        h_name = hl
    [../]
    [./hs]
    ...
    [./const]
        ...
        prop_names =  'Vm         gab mu   S     Tm   kappa Ll     Ls   f0          La   kappa_cr  Lcr   mu_cr'
        prop_values = '1.1798e-2  1.5 12.0 1.9e3 1660 1.5   25.3   0.03 1.41044e-1  0.03 3.85e-2   3e-5  1.0'
    [../]
    [./Mobility]
        type = ParsedMaterial
        property_name = Dchi
    ...
    [./diffusivity]
        type = ParsedMaterial
        property_name = D
        coupled_variables = 'T liquid gr0 gr1 gr2 gr3 gr4 gr5 alphaP'
        material_property_names = 'Ds'
        expression = 'Ds*(1- (0.5*tanh(20*((1-(gr0+gr1+gr2+gr3+gr4+gr5+alphaP))-0.1)) + 0.5)) + 1000*Ds*(0.5*tanh(20*((1-(gr0+gr1+gr2+gr3+gr4+gr5+alphaP))-0.1)) + 0.5)'
    [../]
    [./chi]
        type = DerivativeParsedMaterial
        property_name = chi
        material_property_names = 'Vm hl(liquid,gr0,gr1,gr2,gr3,gr4,gr5,alphaP) kl hs(liquid,gr0,gr1,gr2,gr3,gr4,gr5,alphaP) ka kb hb(liquid,gr0,gr1,gr2,gr3,gr4,gr5,alphaP)'
        expression = '(hs/ka + hb/kb + hl/kl)/(Vm^2)'
        coupled_variables = 'liquid gr0 gr1 gr2 gr3 gr4 gr5 alphaP'
        derivative_order = 2
    [../]
    [mobility]
        type = ParsedMaterial
        ...
        coupled_variables = 'liquid gr0 gr1 gr2 gr3 gr4 gr5 alphaP'
        expression = 'Ls*(1- (0.5*tanh(20*((1-(gr0+gr1+gr2+gr3+gr4+gr5+alphaP))-0.1)) + 0.5)) + Ll*(0.5*tanh(20*((1-(gr0+gr1+gr2+gr3+gr4+gr5+alphaP))-0.1)) + 0.5)*temp_change'
    []
    [tempchange]
        type = DerivativeParsedMaterial
...
[Kernels]
    ...
    [./bulk_gr0]
        type = ACGrGrMulti
        variable = gr0
        v =           'liquid gr1 gr2 gr3 gr4 gr5 alphaP'
        gamma_names = 'gab    gab gab gab gab gab gab'
        mob_name = L
    [../]
    [./sw_gr0]
        type = ACSwitching
        ...
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w liquid gr1 gr2 gr3 gr4 gr5 alphaP'
        mob_name = L
    [../]
    [./int_gr0]
        type = ACInterface
    ...
    [./bulk_gr1]
        type = ACGrGrMulti
        variable = gr1
        v =           'liquid gr0 gr2 gr3 gr4 gr5 alphaP'
        gamma_names = 'gab    gab gab gab gab gab gab'
        mob_name = L
    [../]
    [./sw_gr1]
        ...
        Fj_names = 'omegal omegaa omegab'
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w liquid gr0 gr2 gr3 gr4 gr5 alphaP'
        mob_name = L
    [../]
    [./int_gr1]
        type = ACInterface
    ...
    [./bulk_gr2]
        type = ACGrGrMulti
        variable = gr2
        v =           'liquid gr0 gr1 gr3 gr4 gr5 alphaP'
        gamma_names = 'gab    gab gab gab gab gab gab'
        mob_name = L
    [../]
    [./sw_gr2]
        ...
        Fj_names = 'omegal omegaa omegab'
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w liquid gr0 gr1 gr3 gr4 gr5 alphaP'
        mob_name = L
    [../]
    [./int_gr2]
        type = ACInterface
    ...
    [./bulk_gr3]
        type = ACGrGrMulti
        variable = gr3
        v =           'liquid gr0 gr1 gr2 gr4 gr5 alphaP'
        gamma_names = 'gab    gab gab gab gab gab gab'
        mob_name = L
    [../]
    [./sw_gr3]
        ...
        Fj_names = 'omegal omegaa omegab'
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w liquid gr0 gr1 gr2 gr4 gr5 alphaP'
        mob_name = L
    [../]
    [./int_gr3]
        type = ACInterface
    ...
    [./bulk_gr4]
        type = ACGrGrMulti
        variable = gr4
        v =           'liquid gr0 gr1 gr2 gr3 gr5 alphaP'
        gamma_names = 'gab    gab gab gab gab gab gab'
        mob_name = L
    [../]
    [./sw_gr4]
        ...
        Fj_names = 'omegal omegaa omegab'
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w liquid gr0 gr1 gr2 gr3 gr5 alphaP'
        mob_name = L
    [../]
    [./int_gr4]
        type = ACInterface
    ...
    [./bulk_gr5]
        type = ACGrGrMulti
        variable = gr5
        v =           'liquid gr0 gr1 gr2 gr3 gr4 alphaP'
        gamma_names = 'gab    gab gab gab gab gab gab'
        mob_name = L
    [../]
    [./sw_gr5]
        ...
        Fj_names = 'omegal omegaa omegab'
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w liquid gr0 gr1 gr2 gr3 gr4 alphaP'
        mob_name = L
    [../]
    [./int_gr5]
        type = ACInterface
    ...
    [./bulk_aP]
        type = ACGrGrMulti
        variable = alphaP
        v =           'liquid gr0 gr2 gr3 gr4 gr5 gr1'
        gamma_names = 'gab    gab gab gab gab gab gab'
        mob_name = Lcr
    ...
    [./sw_aP]
        ...
        Fj_names = 'omegal omegaa omegab'
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w liquid gr1 gr2 gr3 gr0 gr4 gr5'
        mob_name = Lcr
    [../]
    [./int_aP]
        type = ACInterface
    ...
    [./bulk_liq]
        type = ACGrGrMulti
        variable = liquid
        v =           'gr0 gr1 gr2 gr3 gr4 gr5 alphaP'
        gamma_names = 'gab gab gab gab gab gab gab'
        mob_name = Ll
    [../]
    [./sw_liq]
        ...
        Fj_names = 'omegal omegaa omegab'
        hj_names = 'hl     hs     hb'
        coupled_variables = 'w gr0 gr1 gr2 gr3 gr4 gr5 alphaP'
        mob_name = Ll
    [../]
    [./int_liq]
        type = ACInterface

...
[Functions]
    [./mu_init]
        type = ParsedFunction
        expression = '((1-y)^2 / ((1-y)^2+y^2))*(-9.07277160e-24 * x^8 + 6.54829086e-20 * x^7 -1.75990977e-16 * x^6 + 1.78776216e-13 * x^5 + 8.25534452e-11 * x^4 -3.79889026e-07 * x^3 + 3.77395516e-04 * x^2 -1.71115386e-01 * x + 3.19768681e1) + (y^2 / ((1-y)^2+y^2))*(2.03969271e-21 * x^6 + 1.14682175e-17 * x^5 -1.02557149e-13 * x^4 + 1.49736654e-10 * x^3 + 8.56010355e-08 * x^2 -6.21570339e-04 * x -1.27632603e-01)'
    [../]
[]
[ICs]
    [./bubble_IC]
...
[Materials]
    ...
    [./const]
        ...
        prop_names =  'Vm         gab mu    S     Tm   kappa  Ll     Ls   f0        Dl'
        prop_values = '1.1798e-2  1.5 0.6   1.9e2 1660 3e-3   15.35  0.15 1.41044e-2 1.5e-1'
    [../]
    [./Mobility]
        type = ParsedMaterial
        property_name = Dchi
    ...
    [./solid_diffusivity]
        ...
        constant_expressions = '8.314 210000 1.5e-5'
    ...
    [./diffusivity]
        ...
        material_property_names = 'Dl Ds'
        expression = 'Ds*(1- (0.5*tanh(20*((1-(gr0+gr1+alphaP))-0.1)) + 0.5)) + Dl*(0.5*tanh(20*((1-(gr0+gr1+alphaP))-0.1)) + 0.5)'
    [../]
    [./chi]
        type = DerivativeParsedMaterial
        property_name = chi
